    ...
    if st.button("Scan FNO Universe"):
        if screener_email:
            ...
            if triggered:
                ...
                html = f"<html><body><h1>VERTEX ALGO | LIVE FNO SCREENER</h1><table><tr><th>Symbol</th><th>Action</th><th>Entry</th><th>Stoploss</th><th>Target</th></tr>{rows}</table></body></html>"
